...
//     signal_attrs); if (sci_err != NvSciError_Success) {
...
//         fprintf(stderr,
//                 "Error: cudaDeviceGetNvSciSyncAttributes failed (code:
//                 %d)\n", cuda_err);
//         goto done;
//     }
...
//     fprintf(
//         stderr,
//         "cudaDeviceGetNvSciSyncAttributes for producer_wait_attrs
//         succeeded\n");
...
//         fprintf(
//             stderr,
//             "Error: NvSciSyncAttrListIpcExportUnreconciled failed (code:
//             %d)\n", sci_err);
//         goto done;
//     }
// done:
